...
mod tests {
    ...
    #[test]
    fn select_room_uses_core_selection_settlement_without_resubscribing_timeline() {
        ...
        assert!(select_room_source.contains("state.runtime.attach"));
        assert!(select_room_source.contains("select_room_and_wait"));
        assert!(select_room_source.contains("SELECT_ROOM_EVENT_TIMEOUT"));
        assert!(!select_room_source.contains("build_select_room_command"));
        assert!(!select_room_source.contains("wait_for_selected_room"));
        assert!(!select_room_source.contains("build_subscribe_timeline_command"));
        assert!(!select_room_source.contains("account_key_from_snapshot"));
    }
    ...
    fn room_transition_and_backfill_commands_emit_submit_trace_tokens() {
        ...
        assert!(
            ...
            "select_room should use Core-owned selection submission"
        );
        assert!(
            paginate_source
    ...
    fn select_search_result_selects_room_then_enters_anchored_timeline_without_room_resubscribe() {
        ...
        let select_room_token = "select_room_and_wait";
        ...
        assert!(
            select_source.contains("select_room_and_wait"),
            "select_search_result should use Core-owned room selection settlement"
        );
        assert!(
        ...
        assert!(
            select_offset < open_offset && open_offset < anchor_offset,
