...
const en: Catalog = {
  ...
  "gate.cleanupDialogCopy": "Koushi will remove this device from your Matrix account first, then erase local messages and encryption keys on this computer. This cannot be undone.",
...
const ja: Catalog = {
  ...
  "gate.cleanupDialogCopy": "最初に Matrix アカウントからこのデバイスを削除し、その後このコンピューター上のローカルメッセージと暗号化キーを消去します。この操作は元に戻せません。",
