...
fn manifest() -> ExportManifest {
    ...
    manifest.upsert_room("!a:example.org", "A (00000001)", ManifestRoomStatus::Completed, HistoryExportRoomCounts {
        exported_events: 3,
...
fn upsert_updates_in_place_and_keeps_order() {
    ...
    manifest.upsert_room("!b:example.org", "B (00000002)", ManifestRoomStatus::Pending, HistoryExportRoomCounts::default());
    manifest.upsert_room("!a:example.org", "A (00000001)", ManifestRoomStatus::Failed, HistoryExportRoomCounts::default());
