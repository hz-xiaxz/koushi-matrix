...
mod tests {
    ...
    use koushi_state::{
        DisplaySettings, RoomLatestEventSummary, RoomSummary, RoomTags, SessionInfo, SettingsPatch,
        SpaceMemberEntry, SpaceMemberMembership, SpaceMembersProjection, UserProfile,
    };
