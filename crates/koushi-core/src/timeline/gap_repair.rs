...
impl TimelineManagerActor {
    async fn invalidate_live_tail_epoch_for_existing_rooms(
        &mut self,
        service_epoch: u64,
    ...
    async fn handle_all_rooms_response_committed(
        &mut self,
        core_generation: u64,
    ...
    async fn apply_live_tail_scheduler_actions(
        &mut self,
    ...
    async fn handle_live_tail_refresh_completed(
        &mut self,
        key: TimelineKey,
...
impl GlobalResponseCommit {
    fn new(core_generation: u64, response_sequence: u64) -> Self {
        Self {
            core_generation,
            response_sequence,
        }
...
impl GlobalCommitFence {
    fn note_room_checkpoint_advanced(&mut self, response_sequence: u64) {
        if self
    ...
    fn observe(&mut self, commit: GlobalResponseCommit) -> GlobalCommitDecision {
...
impl TimelineGapRepairTracker {
    ...
    fn begin_explicit_demand(&mut self) -> u64 {
...
impl TimelineActor {
    fn start_live_tail_refresh(&mut self, epoch: u64, operation_generation: u64, limit: u16) {
    ...
    async fn handle_live_tail_refresh_finished(
        &mut self,
        actor_generation: u64,
        epoch: u64,
        operation_generation: u64,
