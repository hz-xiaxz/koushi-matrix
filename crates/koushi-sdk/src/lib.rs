...
pub use e2ee::{
    ...
    MatrixRoomKeyReshareTarget, MatrixRoomKeyWithheldCode, MatrixSasState, MatrixSasStateStream,
    MatrixSasVerificationHandle, MatrixSecureBackupInspection, MatrixSecureBackupLocalState,
    ...
    MatrixSecureBackupUploadState, MatrixVerificationCancelKind, MatrixVerificationRequestHandle,
    MatrixVerificationRequestState, MatrixVerificationRequestStateStream, RoomKeyExportSummary,
    RoomKeyImportSummary, SecureBackupSetupSummary, SecureBackupStateStream,
    accept_sas_verification, accept_verification_request, account_management_capabilities,
    bootstrap_cross_signing, bootstrap_secure_backup, cancel_own_user_sas_verification,
    cancel_sas_verification, cancel_verification_request, change_password,
    change_secure_backup_passphrase, cleanup_current_device, complete_identity_reset,
    confirm_sas_verification, cross_signing_status, current_outbound_group_session_index,
    ...
    restore_key_backup, room_key_receive_diagnostics, room_key_withheld_codes,
    room_key_withheld_stream, share_index0_room_key, start_own_user_sas_verification,
