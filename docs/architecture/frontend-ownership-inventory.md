...
| Identify duplicated Rust/TS semantics | **Complete as inventory; partial as migration:** thread/ACK duplication is removed; Phases 4.1–4.3b classify/bound demand, 4.3c–4.3e remove invite/cancel/role latest-click authority, and 4.4 proves navigation epochs renderer-specific. Alias/caption retain gates. |
...
| One documented semantic owner per migrated subsystem | **Partial overall; complete through Phase 4.4:** Rust owns submitted navigation, invite query/workflow/execution/cancellation/role and other migrated semantics; renderer epochs own only pre-submit/mounted/cross-surface intent or local failure, and bounded adapters own delivery/dedupe/convergence. |
...
| Focused transition/teardown/projection-equivalence tests | **Partial overall; complete through Phase 4.4:** deferred tests cover convergence, replacement, bounded demand, rapid duplicate first-admitted invite/cancel/role settlement, navigation A/B/cross-family ordering, retry and panel close/reopen. |
