...
Status: Phases 0, 1 (#708 / PR #710), 2A (PR #711), 2B1–2B4 (PRs #712–#715), 3 (PR #716), 4.1 (PR #720), 4.2 (PR #721), 4.3a (PR #722), 4.3b (PR #723), and 4.3c (PR #724) merged. Phase 4.3d is implemented, locally verified and approved by exact-final-diff review, pending PR/CI; later implementation remains unauthorized by this document alone.
