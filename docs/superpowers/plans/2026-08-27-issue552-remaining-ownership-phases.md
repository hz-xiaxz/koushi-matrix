...
Status: Phases 0, 1 (#708 / PR #710), 2A (PR #711), 2B1 (PR #712), 2B2 (PR #713), and 2B3 (PR #714) merged. Phase 2B4 design is pending independent review; later implementation remains unauthorized by this document alone.
...
4. Core/state/menu event subscriptions — Phase 2B4 design pending review.
